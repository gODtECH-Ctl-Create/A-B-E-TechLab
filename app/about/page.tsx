...
export default function About(){return <div>
  <section className="grid-bg"><div className="container py-24 md:py-32"><p className="text-xs font-semibold uppercase tracking-[.18em] text-black/45">About ABE TechLab</p><h1 className="font-display mt-6 max-w-5xl text-6xl font-semibold leading-[.9] tracking-[-.07em] md:text-8xl">Small studio. Serious products.</h1><p className="mt-8 max-w-2xl text-lg leading-8 text-black/55">A focused product and technology studio working across digital products, education technology and the systems behind them.</p></div></section>

  <section className="container py-24 md:py-32"><div className="grid gap-12 md:grid-cols-[.8fr_1.2fr]"><div><p className="text-xs uppercase tracking-[.16em] text-black/40">Why we exist</p></div><div className="max-w-2xl text-lg leading-8 text-black/65"><p>Great ideas often get stuck between having a vision and actually building the thing. ABE TechLab exists to close that gap.</p><p className="mt-7">We work at the intersection of product, design and technology. That includes digital products for businesses and organizations, as well as education technology that supports the way people learn, teach and develop.</p><p className="mt-7">TechTrack is one example of that focus: a learning and development product built around courses, bootcamps and internship experiences.</p><p className="mt-7">We don't believe every project needs a large agency. It needs the right thinking, the right people and a clear path to shipping.</p></div></div></section>
