  ...
  return (
    <>
      ...
      <section className="container py-28 md:py-36">
        <div className="overflow-hidden border border-black/10 bg-black/10 grid gap-px md:grid-cols-2">
          <div className="bg-[#f5f5ef] p-8 md:p-10">
            <SectionLabel>What we do</SectionLabel>
            <h2 className="font-display max-w-md text-4xl font-semibold leading-[.95] tracking-[-.055em] md:text-6xl">From a rough idea to something people can use and grow.</h2>
          </div>
