...
export default function Home() {
  return (
    <>
        ...
        <div className="container py-12 md:py-20">
          <div className="grid items-center gap-12 lg:grid-cols-[.95fr_1.05fr] lg:gap-16">
            <div className="reveal">
              ...
              <div className="mt-9 flex flex-wrap gap-3"><Link href="/contact" className="btn-primary px-6 py-4 text-sm font-semibold transition">Start a project</Link><Link href="/services" className="btn-secondary px-6 py-4 text-sm font-semibold transition">Explore our services</Link></div>
      ...
      <section className="cta-section relative overflow-hidden bg-[#b7ff3c]"><div className="absolute -right-20 top-1/2 h-80 w-80 -translate-y-1/2 rounded-full bg-white/40 blur-[100px]" /><div className="container relative flex flex-col gap-8 py-24 md:flex-row md:items-end md:justify-between md:py-36"><div><SectionLabel>Start a conversation</SectionLabel><h2 className="font-display max-w-3xl text-5xl font-semibold leading-[.92] tracking-[-.06em] md:text-7xl">Have a problem worth solving?</h2><p className="mt-6 max-w-xl text-base leading-7 text-black/65">Tell us what you are trying to build, improve or figure out. We will help you find the clearest next step.</p></div><Link href="/contact" className="inline-flex items-center gap-2 bg-black px-6 py-4 text-sm font-semibold text-white transition hover:-translate-y-1 focus-visible:outline-3 focus-visible:outline-offset-3 focus-visible:outline-black">Start a project <ArrowUpRight size={17}/></Link></div></section>
    </>
  );
}
