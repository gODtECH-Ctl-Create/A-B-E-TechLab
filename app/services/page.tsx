...
const heroVisuals = [
  { src: 'https://images.pexels.com/photos/7988758/pexels-photo-7988758.jpeg?auto=compress&cs=tinysrgb&w=1800', alt: 'Technology team presenting and discussing a project' },
  { src: 'https://images.pexels.com/photos/12899191/pexels-photo-12899191.jpeg?auto=compress&cs=tinysrgb&w=1800', alt: 'Developers discussing software development in an office' },
  { src: 'https://images.pexels.com/photos/7988742/pexels-photo-7988742.jpeg?auto=compress&cs=tinysrgb&w=1800', alt: 'Developers collaborating on technology work' },
];

export default function Services(){
  return <div>
    <section className="grid-bg"><div className="container py-24 md:py-32"><p className="text-xs font-semibold uppercase tracking-[.18em] text-black/45">Services</p><h1 className="font-display mt-6 max-w-5xl text-6xl font-semibold leading-[.9] tracking-[-.07em] md:text-8xl">Product thinking, design and technology in one place.</h1><p className="mt-8 max-w-2xl text-base leading-7 text-black/55">We help organisations move from ideas and operational problems to clearer products, stronger systems and technology that works in practice.</p><HeroVisualCarousel visuals={heroVisuals} /></div></section>
