...
const article: Insight = {
  slug: 'from-construction-problem-to-procurement-platform',
  title: 'From a Construction Problem to a Procurement Platform',
  excerpt: 'How product thinking can turn a fragmented construction procurement experience into a clearer digital marketplace.',
  category: 'Technology',
  publishedAt: '2026-08-16',
  readTime: '6 min read',
  author: 'ABE TechLab',
  relatedSlugs: ['teaching-technology-is-more-than-an-lms', 'what-abe-techlab-builds'],
  relatedPaths: ['/products', '/services'],
  content: [
