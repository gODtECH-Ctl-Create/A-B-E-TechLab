...
const article: Insight = {
  slug: 'why-product-research-comes-before-building',
  title: 'Why Product Research Should Come Before Building',
  excerpt: 'Good product development starts by understanding the problem, people and opportunity before deciding what to build.',
  category: 'Research',
  publishedAt: '2026-08-16',
  readTime: '6 min read',
  author: 'ABE TechLab',
  relatedSlugs: ['what-abe-techlab-builds', 'product-marketing-starts-before-launch'],
  relatedPaths: ['/services', '/about'],
  content: [
